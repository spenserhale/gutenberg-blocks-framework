...
use SH\GutenbergBlocks\View\ViewInterface;
...
final class Loader
{
     ...
     * Use `SH\GutenbergBlocks\Loader::CORE_BLOCK_WHITELIST` and merge it with your array to extend the current whitelist.
     *
    ...
    /**
     * Sets the path of the directory of your translation file (e.g. SH-de_DE.json) to translate strings in your custom block in the admin.
     ...
     *
     * - `SH\GutenbergBlocks\View\PhpView` (default)
     * - `SH\GutenbergBlocks\View\TwigView` (requires `twig/twig`)
     * - `SH\GutenbergBlocks\View\TimberView` (requires `timber/timber`)
     *
